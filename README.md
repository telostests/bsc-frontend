...
```
cd existing_repo
git remote add origin https://gitlab.com/steban1/frontend-bsc.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/steban1/frontend-bsc/-/settings/integrations)
