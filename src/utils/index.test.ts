...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@encodix/sdk-bsc'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('ropsten', () => {
      expect(getEtherscanLink(3, 'abc', 'address')).toEqual('https://ropsten.bscscan.com/address/abc')
    })
    it('enum', () => {
      expect(getEtherscanLink(ChainId.RINKEBY, 'abc', 'address')).toEqual('https://rinkeby.bscscan.com/address/abc')
    })
  })
