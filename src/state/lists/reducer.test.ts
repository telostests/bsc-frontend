  ...
  describe('removeList', () => {
    ...
    it('selects the default list if removed list was selected', () => {
      store = createStore(reducer, {
        ...
        selectedListUrlBSC: 'fake-url'
      })
      store.dispatch(removeList('fake-url'))
      expect(store.getState()).toEqual({
        byUrl: {},
        selectedListUrlBSC: 'tokens.uniswap.eth'
      })
    })
  })
  ...
  describe('selectList', () => {
    ...
    it('selects if not present already', () => {
      ...
      expect(store.getState()).toEqual({
        ...
        selectedListUrlBSC: 'fake-url-invalid'
      })
    })
  ...
  describe('updateVersion', () => {
    describe('never initialized', () => {
      ...
      it('sets selected list', () => {
        expect(store.getState().selectedListUrlBSC).toEqual(DEFAULT_TOKEN_LIST_URL)
      })
